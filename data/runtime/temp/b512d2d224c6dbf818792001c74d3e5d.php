                    ...
                    <div class="tab-pane active" id="tab-first">
                        <table class="table table-hover">
                            ...
                            <tr class="del_tr">
                                ...
                                <td width="400px"><?php echo subtext($v['post_excerpt'],80); ?></td>
