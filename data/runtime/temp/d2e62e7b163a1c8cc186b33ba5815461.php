<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"C:\Users\Administrator\Desktop\chat/app/home\view\login\register_home_page.html";i:1500947316;s:69:"C:\Users\Administrator\Desktop\chat/app/home\view\Public\head_in.html";i:1500947316;s:67:"C:\Users\Administrator\Desktop\chat/app/home\view\Public\alert.html";i:1498813495;}*/ ?>
<!DOCTYPE html>
...
<div class="login-container">
    <div class="login-box animated bounceInDown">
        ...
        <div class="login-body ">
            <div class="login-title animated fadeIn"><strong>欢迎使用</strong>, 请注册</div>
            <form id="login_in_form" action="<?php echo url('home/Login/register_think'); ?>" class="form-horizontal" method="post">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <input name="confirm_pass" type="password" class="form-control" placeholder="确认密码"/>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-12">
        ...
        <div class="login-footer">
            <div class="pull-left">
                <a href="<?php echo url('home/login/login_home_page'); ?>">已有账号</a>
            </div>
