<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:62:"C:\code_edd\201706\alphacms/app/admin\view\menu\home_page.html";i:1500475366;s:62:"C:\code_edd\201706\alphacms/app/admin\view\Public\content.html";i:1499229828;s:62:"C:\code_edd\201706\alphacms/app/admin\view\Public\head_in.html";i:1499053602;s:60:"C:\code_edd\201706\alphacms/app/admin\view\Public\alert.html";i:1498813495;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="tab-pane <?php echo !empty($menuChild)?$menuChild:'active'; ?>" id="tab-first">
                        <table  class="demo1 table datatable table-hover">
                            ...
                            <tr class="del_tr">
                                ...
                                <td><input style="width: 70px" type="number" class="order_change form-control" data-url="<?php echo url('admin/menu/update_order'); ?>" pk-id="<?php echo $v['id']; ?>" value="<?php echo $v['listorder']; ?>"></td>
                                <td>
