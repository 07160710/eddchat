<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:66:"C:\web\eddchat_wrkb2y\web/app/admin\view\setting\plugins_home.html";i:1499997377;s:60:"C:\web\eddchat_wrkb2y\web/app/admin\view\Public\content.html";i:1499229828;s:60:"C:\web\eddchat_wrkb2y\web/app/admin\view\Public\head_in.html";i:1499053602;s:58:"C:\web\eddchat_wrkb2y\web/app/admin\view\Public\alert.html";i:1498813495;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="col-md-12">
                            <div class="widget widget-<?php echo $v['wid_color']; ?> widget-item-icon">
                                ...
                                <div class="widget-data">
                                    <div class="widget-int num-count"><?php echo $v['wid_name']; ?>|<?php echo $v['wid_id']; ?></div>
                                    <?php $_597722f16a4bc=get_param_arr($v['wid_params']); if(is_array($_597722f16a4bc) || $_597722f16a4bc instanceof \think\Collection || $_597722f16a4bc instanceof \think\Paginator): if( count($_597722f16a4bc)==0 ) : echo "" ;else: foreach($_597722f16a4bc as $key=>$k): ?>
                                    <div class="widget-subtitle"><?php echo $k; ?></div>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                                <div class="widget-controls">
                                    <a href="#" data-url="<?php echo url('admin/Setting/del_plugins_think',['wid_id'=>$v['wid_id']]); ?>" onclick="del_wid(this)" class="widget-control-right widget-remove" data-toggle="tooltip" data-placement="top" title="删除模块"><span class="fa fa-times"></span></a>
                                </div>
                            </div>
                        </div>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
