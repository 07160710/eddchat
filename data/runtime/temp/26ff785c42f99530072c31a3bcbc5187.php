<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"C:\web\eddchat_wrkb2y\web/app/admin\view\login\login_page.html";i:1501168969;s:58:"C:\web\eddchat_wrkb2y\web/app/admin\view\Public\alert.html";i:1498813495;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="login-box animated bounceInDown">
        ...
        <div  class="login-body ">
            ...
            <form id="login_in_form" action="<?php echo url('admin/Login/login_in'); ?>" class="form-horizontal" method="post">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="l-captcha" data-width='100%' data-site-key="19d4e7396b5bda1e1db0442b9d28219d"></div>
