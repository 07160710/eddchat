                ...
                <div class="panel-body tab-content">
                    <div class="tab-pane active" id="tab-first">
                        <table class="table table-hover">
                            ...
                            <tr class="del_tr">
                                <td><?php echo subtext($v['post_title'],50); ?></td>
                                <td><?php echo subtext($v['post_excerpt'],80); ?></td>
